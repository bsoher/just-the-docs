...
Gem::Specification.new do |spec|
  ...
  spec.homepage      = "https://github.com/bsoher/just-the-docs"
  spec.license       = "MIT"
  spec.metadata      = {
    "bug_tracker_uri"   => "https://github.com/bsoher/just-the-docs/issues",
    "changelog_uri"     => "https://github.com/bsoher/just-the-docs/blob/main/CHANGELOG.md",
    "documentation_uri" => "https://just-the-docs.com/",
    "source_code_uri"   => "https://github.com/bsoher/just-the-docs",
  }
